  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900">
      <div className="mx-auto min-h-screen max-w-md bg-slate-100 pb-24 md:max-w-3xl lg:max-w-6xl xl:max-w-7xl">
        ...
        {screen === "dashboard" ? (
          <div className="sticky top-0 z-20 bg-slate-100/95 px-4 pb-3 backdrop-blur lg:static lg:bg-transparent lg:backdrop-blur-0">
            <SectionToggle
          ...
          <div className="space-y-4 lg:col-span-12">
            ...
            {screen === "site" && (
              <>
                ...
                <div className="space-y-3">
                  {jobStats.length ? (
                    jobStats.map((item) => <JobCard key={item.jobId} item={item} onOpen={openJob} advanced={siteViewMode === "advanced"} />)
                  ) : (

        ...
        <div className="loginWrap">
          <div className="loginCard">
            ...
            <p className="loginText">
              Versione solo mobile. Il sito legge i dati dal Google Sheets master.
            </p>
      ...
      <div className="app">
        <header className="mobileHeader">
          ...
          <div className="siteSwitchWrap">
            ...
            <button className="logoutMini" onClick={logout}>
              Esci
            </button>
          </div>
        </header>
              ...
              {!selectedJob ? (
                <>
                  <div className="pageHead">
                    <h2>Lavorazioni</h2>
                    <p>{query ? "Risultati filtrati dalla ricerca." : "Vista completa delle lavorazioni."}</p>
                  </div>
...
.siteSwitchWrap{display:flex;gap:8px;align-items:center;margin-top:12px}
.siteSelect{flex:1;border:1px solid #cbd5e1;background:#fff;outline:none;padding:12px 13px;border-radius:14px}
.logoutMini{border:1px solid #cbd5e1;background:#fff;color:#0f172a;border-radius:14px;padding:12px 13px;font-weight:600}
